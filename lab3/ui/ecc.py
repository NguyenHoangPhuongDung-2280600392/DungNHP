...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(652, 509)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(270, 30, 71, 16))
        ...
        self.btn_genkeys.setGeometry(QtCore.QRect(360, 50, 75, 23))
        ...
        self.btn_verify.setGeometry(QtCore.QRect(400, 430, 75, 23))
        self.btn_verify.setObjectName("btn_verify")
        self.txt_info = QtWidgets.QTextEdit(self.centralwidget)
        self.txt_info.setGeometry(QtCore.QRect(120, 120, 491, 131))
        self.txt_info.setObjectName("txt_info")
        self.txt_sign = QtWidgets.QTextEdit(self.centralwidget)
        self.txt_sign.setGeometry(QtCore.QRect(120, 280, 491, 131))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_genkeys.setText(_translate("MainWindow", "Gen Keys"))
